...
- Run `swift build && swift test` on macOS 26 before every push. Automated CI repeats both checks for pull requests and updates to `main`; state the local `swift test` result in the PR.
